...
const TreeDetail: React.FC<TreeDetailProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-card rounded-3xl shadow-soft max-w-lg w-full max-h-[90vh] overflow-y-auto animate-gentle-scale">
        ...
        <div className="p-8">
          ...
          <p className="text-muted-foreground italic mb-8">Quercus robur</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="p-4 rounded-xl bg-muted/50">
              ...
              <p className="font-medium text-foreground">North Grove</p>
            </div>
            <div className="p-4 rounded-xl bg-muted/50">
              <div className="flex items-center gap-2 text-muted-foreground mb-1">
            ...
            <div className="p-4 rounded-xl bg-muted/50">
              ...
              <p className="font-medium text-foreground">47 times</p>
            </div>
          </div>
